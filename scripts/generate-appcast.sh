...
echo "  2. cp .build/appcast.xml appcast.xml"
echo "  3. git add appcast.xml && git commit -m 'Update appcast to v${VERSION}'"
echo "  4. git push origin gh-pages"
echo "  5. git checkout main"
echo ""
echo "Verify: curl -s https://kylenesium.github.io/AIBattery/appcast.xml | grep sparkle:version"
