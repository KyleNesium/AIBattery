...
**802 tests** across 56 test files.

| Area | Tests | What's covered |
|------|-------|----------------|
| Models | 233 | Token summaries, rate limit parsing, health status, metric modes, API profiles, usage snapshots (incl. escalation ladder, hysteresis), model pricing, Claude system status indicators |
