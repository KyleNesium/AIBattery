...
**551 tests** across 37 test files.
...
| ViewModels | 25 | UsageViewModel static helpers (refresh interval clamping, error message logic, adaptive polling data-change detection, throttle event recording with dedup + exhaustion detection, throttle count filtering) |
