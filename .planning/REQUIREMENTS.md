...
- [ ] **BUG-02**: Context window auto-detect adjusts downward when session data indicates a smaller tier
- [ ] **BUG-03**: `estimatedTimeToLimit` provides projections below 50% utilization
